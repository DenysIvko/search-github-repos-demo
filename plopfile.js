module.exports = (plop) => {
  plop.setGenerator('component', {
    ...
    actions: [{
      ...
      templateFile: 'src/utils/plop-templates/component/{{type}}.hbs'
    }, {
      type: 'add',
      path: 'src/components/{{properCase name}}/__tests__/{{properCase name}}.spec.js',
      templateFile: 'src/utils/plop-templates/component/component-spec.hbs'
    }, {
      type: 'add',
      path: 'src/components/{{properCase name}}/{{properCase name}}.scss',
      templateFile: 'src/utils/plop-templates/component/css.hbs'
    }, {
      type: 'add',
      path: 'src/components/{{properCase name}}/index.js',
      templateFile: 'src/utils/plop-templates/component/index-export.hbs'
    }],
  });
  ...
  plop.setGenerator('container', {
    ...
    actions: [{
      ...
      templateFile: 'src/utils/plop-templates/component/container.hbs'
    }, {
      type: 'add',
      path: 'src/containers/{{properCase name}}/__tests__/{{properCase name}}.spec.js',
      templateFile: 'src/utils/plop-templates/component/container-spec.hbs'
    }, {
      type: 'add',
  ...
  plop.setGenerator('reducer', {
    ...
    actions: [{
      ...
      templateFile: 'src/utils/plop-templates/reducer/reducer.hbs'
    }, {
      type: 'add',
      path: 'src/reducers/{{lowerCase name}}/__tests__/{{lowerCase name}}.reducer.spec.js',
      templateFile: 'src/utils/plop-templates/reducer/reducer-spec.hbs'
    }, {
      type: 'add',
      path: 'src/reducers/{{lowerCase name}}/__tests__/{{lowerCase name}}.action-creators.spec.js',
      templateFile: 'src/utils/plop-templates/reducer/action-creators-spec.hbs'
    }, {
      type: 'add',
      path: 'src/reducers/{{lowerCase name}}/__tests__/{{lowerCase name}}.selectors.spec.js',
      templateFile: 'src/utils/plop-templates/reducer/selectors-spec.hbs'
    }, {
      type: 'add',
      path: 'src/reducers/{{lowerCase name}}/__tests__/{{lowerCase name}}.thunks.spec.js',
      templateFile: 'src/utils/plop-templates/reducer/thunks-spec.hbs'
    }],
  });
  ...
  plop.setGenerator('util', {
    ...
    actions: [{
      ...
      templateFile: 'src/utils/plop-templates/generic/generic.hbs'
    }, {
      type: 'add',
      path: 'src/utils/{{lowerCase name}}/__tests__/{{lowerCase name}}.spec.js',
      templateFile: 'src/utils/plop-templates/generic/generic-spec.hbs'
    }],
  });
};
